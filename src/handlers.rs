...
fn create_resume_data() -> ResumeItem {
    ...
    ResumeItem {
        ...
        awards: vec![
            Award { name: "AP Scholar with Distinction".to_string(), description: "".to_string(), date: "2025".to_string(), attachment: "".to_string() },
            Award { name: "STEM Light House Challenge".to_string(), description: "2nd place".to_string(), date: "2023".to_string(), attachment: "".to_string() },
            Award { name: "National Honor Society (NHS) Member".to_string(), description: "".to_string(), date: "2024 - 2026".to_string(), attachment: "".to_string() },
            Award { name: "Congressional Award".to_string(), description: "Gold certificate".to_string(), date: "2024".to_string(), attachment: "congressional_award.pdf".to_string() },
            Award { name: "Congressional Certificate of Appreciation".to_string(), description: "YCFL".to_string(), date: "2023 - 2025".to_string(), attachment: "".to_string() },
            Award { name: "President's Volunteer Service Award".to_string(), description: "".to_string(), date: "2023".to_string(), attachment: "".to_string() },
            Award { name: "American Computer Science League (ACSL) All Star Senior".to_string(), description: "Gold Medal".to_string(), date: "2023".to_string(), attachment: "".to_string() },
            Award { name: "American Computer Science League (ACSL) All Star Intermediate".to_string(), description: "Gold Medal".to_string(), date: "2022".to_string(), attachment: "".to_string() },
            Award { name: "Bergen County Academies Science Olympiad".to_string(), description: "2nd place".to_string(), date: "2022".to_string(), attachment: "".to_string() },
            Award { name: "USA Computing Olympiad (USACO)".to_string(), description: "Platinum level".to_string(), date: "2022 - 2023".to_string(), attachment: "".to_string() },
            Award { name: "Veterans of Foreign Wars (VFW) Voice of Democracy County winner".to_string(), description: "".to_string(), date: "2022 - 2023".to_string(), attachment: "".to_string() },
            Award { name: "Bergen Science Fair".to_string(), description: "3rd place & Broadcom Coding with Commitment Award".to_string(), date: "2022".to_string(), attachment: "".to_string() },
            Award { name: "Scholastic Art & Writing Award".to_string(), description: "Silver Key".to_string(), date: "".to_string(), attachment: "".to_string() },
        ],
        certifications: vec![
